...
const moreContent0 = document.querySelector(".hide-0");
const seeMoreBtn0 = document.querySelector(".see-more-0");
...
seeMoreBtn0.addEventListener('click', () => {
    ...
    if(seeMoreBtn0.innerHTML === 'see more') {
        ...
        seeMoreBtn0.innerHTML = 'see more';        
        moreContent0.style.display = "none";
    }
});


const moreContent1 = document.querySelector(".hide-1");
const seeMoreBtn1 = document.querySelector(".see-more-1");
...
const moreContent2 = document.querySelector(".hide-2");
const seeMoreBtn2 = document.querySelector(".see-more-2");
...
const moreContent3 = document.querySelector(".hide-3");
const seeMoreBtn3 = document.querySelector(".see-more-3");
...
seeMoreBtn3.addEventListener('click', () => {
    ...
    if(seeMoreBtn3.innerHTML === 'see more') {
        ...
        seeMoreBtn3.innerHTML = 'see more';        
        moreContent3.style.display = "none";
    }
});
